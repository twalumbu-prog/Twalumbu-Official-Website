  ...
  return (
    <section className="hero-container">
      ...
      <motion.div
        ...
        animate={reduceMotion ? { opacity: 0.3 } : { x: [-5, 5, -5], y: [-2, 4, -2] }}
      ...
      <div className="hero-text-content">
        ...
        <motion.div
          ...
          animate={reduceMotion ? { rotate: 0, scale: 1 } : { rotate: [0, 10, -10, 0], scale: [1, 1.05, 1] }}
      ...
      >
        <div className="image-outer-frame">
          <motion.img
            ...
            fetchPriority="high"
            loading="eager"
            animate={reduceMotion ? { scale: 1 } : { scale: [1, 1.1] }}
            transition={
              reduceMotion
                ? { duration: 0 }
